...
const ui_static = /^win/.test(process.platform) ? `//ui-static/wwwroot/promo/bns/event/2018/180919_specialoffer` : `/Volumes/wwwroot/promo/bns/event/2018/180919_specialoffer`;
...
gulp.task('packaging', () => {
    return gulp.src([`${Path.local}/dist/**/*`])
               .pipe(zip(`180919_specialoffer.zip`))
